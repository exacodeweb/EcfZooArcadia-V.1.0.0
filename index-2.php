  ...
  <head>
    ...
    <style>
      ...
      body {
        ...
        /* a activer pour que l'image couvre tout l'écran ! voir les autreq parametre a desactiver comme #about */
        /*
          background-image: url('./assets/images/image-resize-(7).jpg');
          /*../public/asset/images/nature-background.jpg*/
        /*
        ...
        /*font-family: 'Roboto', sans-serif;
          ...
          margin: 0;*/
        /*--------------------------------------------------------------------------------------------------------------*/
        /*background: linear-gradient(to bottom, #a8dadc, #556b2f	);/* #457b9d*/
        /*font-family: 'Roboto', sans-serif;
        color: #1d3557;
        margin: 0;*/
        /*--------------------------------------------------------------------------------------------------------------*/
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        const timeConfig = {
          ...
          nightStart: 18 // Début du style nuit
        };
  ...
  <body>
    ...
    <main class="container-body">
      ...
      <style>
        ...
        #hero {
          background: url('./public/assets/images/image5.jfif') no-repeat center center/cover;/*./assets/images/image-resize-(7).jpg*/
      ...
      <style>
        ...
        #about {
          padding: 2rem;
          text-align: center;
          /* background: #fff;/* à désactiver pour image de fond body */
        }
      ...
      <!--<div class="text-overlay">Description de l'habitat 2</div>
              <div class="text-overlay animate-on-scroll">La Savane</div> --> <!-- Description de l'habitat 2 --> <!--
            </div>
          </div>
          <div class="col-md-4">
            <div class="image-container">
