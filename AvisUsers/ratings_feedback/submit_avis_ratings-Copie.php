...
$db = new PDO('mysql:host=localhost;dbname=zoo_arcadia', 'utilisateur_zoo', 'Z00_Arcadia!2024');//username //password
$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

// Requête préparée pour insérer un témoignage
$query = $db->prepare("
    INSERT INTO avisusers (nom, email, message, note, image_profil, is_approved)
    VALUES (:nom, :email, :message, :note, :image_profil, :is_approved)
");
...
$data = [
    ...
    ':is_approved' => 0, // Par défaut, témoignage non approuvé
];
