...
<!-- Section À propos -->
    ...
    <section class="image-text-section image-left">
      ...
      <div id="habitats" class="image">
        <a href="./public/habitats.php">
          <img src="./public/asset/images/image1.jpg" alt="Image gauche"></a><!--./assets/images/Bientot dispon.png --><!-- https://via.placeholder.com/400 -->
      </div>
    ...
    <section class="image-text-section image-right">
      ...
      <div class="text">
        <h2>Titre de la section Animaux</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus lacinia odio vitae vestibulum vestibulum.</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="image-container">
            ...
            <div class="text-overlay">Description de l'habitat 3</div>
