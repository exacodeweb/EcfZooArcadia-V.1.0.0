...
if (!isset($_SESSION['user_id'])) {//username
  header('Location: ../config/admin-2login.php');//../admin-2/admin-2login.html
...
<body>
  ...
  <div class="btn-card"><!--./pages/inscription-(desactiver).html-->
    <a href="./pages/employe_dashboard.php" title="cliquer Laisser un avis">Retour Tableau de Bord
    </a>
  </div><!--../admin-2/admin_dashboard.php--><!-- ../admin-2/employee_dashboard.php -->
